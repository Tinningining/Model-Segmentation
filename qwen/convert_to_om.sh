...
atc --framework=5 \
    ...
    --input_format=ND \
    --input_shape="hidden_states:1,$SEQ_LEN,$HIDDEN_SIZE;attention_mask:1,1,$SEQ_LEN,$(($MAX_CACHE_LEN+$SEQ_LEN));position_ids:1,$SEQ_LEN;past_key:7,1,$NUM_KV_HEADS,$MAX_CACHE_LEN,$HEAD_DIM;past_value:7,1,$NUM_KV_HEADS,$MAX_CACHE_LEN,$HEAD_DIM" \
    --log=error \
    --soc_version=$SOC_VERSION \
    --precision_mode=must_keep_origin_dtype
