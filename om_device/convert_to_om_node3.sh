#!/bin/bash
# Node 3: layers_21_27.om + output.om (System + Prefill + Decode)
...
# --- System (无 past KV) ---
echo "[System] layers_21_27..."
atc --framework=5 \
    --model="$ONNX_DIR/system/layers_21_27.onnx" \
    --output="$OM_DIR/system/layers_21_27" \
    --input_format=ND \
